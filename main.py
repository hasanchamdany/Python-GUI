...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(637, 393)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(9, 10, 621, 371))
        ...
        self.gridLayout_4.addWidget(self.widget1, 2, 1, 1, 1)
        ...
        spacerItem = QtWidgets.QSpacerItem(508, 0, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Port Serial"))
        self.label_3.setText(_translate("MainWindow", "Window Lenght"))
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">Arduino Live Signal Plot GUI</span></p></body></html>"))
